...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invitations_invitationkey', (
        ...
        db.send_create_signal('invitations', ['InvitationKey'])

        # Adding model 'InvitationUser'
        db.create_table('invitations_invitationuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('invitations', ['InvitationUser'])


    def backwards(self, orm):
        # Deleting model 'InvitationKey'
        db.delete_table('invitations_invitationkey')

        # Deleting model 'InvitationUser'
        db.delete_table('invitations_invitationuser')
