...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvitationKey.use_count'
        db.add_column('invitations_invitationkey', 'use_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvitationKey.use_count'
        db.delete_column('invitations_invitationkey', 'use_count')
