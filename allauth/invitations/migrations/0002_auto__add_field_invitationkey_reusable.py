...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvitationKey.reusable'
        db.add_column('invitations_invitationkey', 'reusable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvitationKey.reusable'
        db.delete_column('invitations_invitationkey', 'reusable')
